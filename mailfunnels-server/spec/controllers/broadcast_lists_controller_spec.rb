...
RSpec.describe BroadcastListsController, type: :controller do
  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      it "renders a JSON response with the new broadcast_list" do

        post :create, params: {broadcast_list: valid_attributes}, session: valid_session
        expect(response).to have_http_status(:created)
        expect(response.content_type).to eq('application/json')
        expect(response.location).to eq(broadcast_list_url(BroadcastList.last))
      end
    end

    context "with invalid params" do
      it "renders a JSON response with errors for the new broadcast_list" do
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "renders a JSON response with the broadcast_list" do
        broadcast_list = BroadcastList.create! valid_attributes
    ...
    context "with invalid params" do
      it "renders a JSON response with errors for the broadcast_list" do
        broadcast_list = BroadcastList.create! valid_attributes
